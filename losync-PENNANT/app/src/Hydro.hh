...
public:
    ...
    int** bcstaskindices;       // Simplifies task dependencies for BCS
    int* bcstasksizes;          // Size of each bcstaskindices[pch] entry
    ...
    double* dtrec;              // maximum timestep for hydro, one entry per task
    char** msgdtrec;            // message:  reason for dtrec
    double* dt;                 // timestep size for all cycles, set after global dt calculation
