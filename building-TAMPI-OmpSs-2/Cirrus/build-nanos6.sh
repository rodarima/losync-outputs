...
TARGET=/lustre/home/shared/dc025/ompss2-2021.06-mpt+extrae/nanos6-install
EXTRAE_HOME=/lustre/home/shared/dc025/ompss2-2021.06-mpt+extrae/extrae
MCXX_HOME=/lustre/home/shared/dc025/ompss2-2021.06-mpt+extrae/mercurium
mkdir -p $TARGET
cd ompss-2-releases/nanos6
autoreconf -fiv
#make clean
./configure --prefix=$TARGET --with-nanos6-mercurium=$MCXX_HOME --with-babeltrace2=/lustre/home/shared/dc025/babeltrace2-2.0.3 --with-extrae=$EXTRAE_HOME
#make -j8 all check
make all check
#make check
make install
